...
from gnupg import __date__ as today
...
latex_documents = [
    (
        "index",
        "GnuPGWrapperforPython.tex",
        u"GnuPG Wrapper for Python Documentation",
        u"Vinay Sajip",
        "manual",
    ),
]
...
man_pages = [
    ("index", "python-gnupg", u"python-gnupg Documentation", [u"Vinay Sajip"], 1)
]
